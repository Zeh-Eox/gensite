    ...
    <>
      <div className="w-full max-w-5xl mx-auto z-20 max-md:px-4 min-h-[80vh]">
        <div className="text-center mt-16">
          <h2 className="text-white/60 text-3xl font-medium">
            Choose Your Plan
          </h2>
          <p className="text-white/70 text-sm max-w-md mx-auto mt-2">
        ...
        <div className="pt-14 py-4 px-4 ">
          <div className="grid grid-cols-1 md:grid-cols-3 flex-wrap gap-4">
            {plans.map((plan, idx) => (
              <div
                key={idx}
                className="p-6 bg-black/40 ring ring-indigo-950 mx-auto w-full max-w-sm rounded-lg text-white shadow-lg hover:ring-indigo-500 transition-all duration-400"
              >
        ...
        <p className="mx-auto text-center text-sm max-w-md mt-10 text-white/60 font-light">
          ...
          purchase more credits anytime from the pricing page.
        </p>
      </div>
